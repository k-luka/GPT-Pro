...
def maybe_init_dist(device: str):
    ...
    backend = "nccl"
    # Single-process rendezvous without env vars or hardcoded ports.
...
def main(cfg: DictConfig):
    ...
    try:
        ...
        prompt = build_prompt_text(cfg.inference.prompt)
        enc, idx = encode_prompt(prompt, device)
